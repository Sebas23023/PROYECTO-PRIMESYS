...
<head>
    ...
    <title>Desarrollo de Apps Móviles - PRIMESYS</title>
        ...
        <div class="px-6 py-8 md:px-12 lg:py-0 lg:pl-8 lg:pr-12 xl:pl-16 xl:pr-20 flex flex-col justify-center flex-grow space-y-8 xl:space-y-10">
            ...
            <div class="space-y-4">
                ...
                <p class="text-base lg:text-lg text-slate-400 font-light leading-7 lg:leading-7 border-l-2 border-slate-700 pl-4 lg:pl-6">
                    El desarrollo de aplicaciones móviles es el proceso de crear software diseñado para funcionar en celulares y tablets, permitiendo a los usuarios acceder a servicios y productos de manera rápida, cómoda y personalizada.
                </p>
            </div>
            ...
            <div class="space-y-6">
                ...
                <p class="text-sm lg:text-base text-slate-300 font-light leading-6">
                    Transformamos ideas en soluciones digitales innovadoras que potencian tu negocio:
                </p>
                ...
                <div class="grid gap-4">
                    ...
                    <div class="group p-4 bg-slate-800/30 rounded-xl hover:bg-slate-800/50 border border-slate-700/50 hover:border-sky-500/30 transition-all duration-300">
                        <div class="flex items-start gap-3 lg:gap-4">
                            <div class="bg-sky-500/10 p-2 lg:p-3 rounded-lg text-sky-400">
                                <svg class="w-5 h-5 lg:w-6 lg:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"></path></svg>
                            </div>
                            <div>
                                <h4 class="text-white font-medium text-base lg:text-lg mb-0.5">Aplicaciones a Medida</h4>
                                <p class="text-xs lg:text-sm text-slate-400 font-light leading-snug">Diseñadas para tu empresa, adaptadas 100% a tus objetivos específicos.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="group p-4 bg-slate-800/30 rounded-xl hover:bg-slate-800/50 border border-slate-700/50 hover:border-purple-500/30 transition-all duration-300">
                        <div class="flex items-start gap-3 lg:gap-4">
                            ...
                            <div>
                                <h4 class="text-white font-medium text-base lg:text-lg mb-0.5">Interfaces Modernas</h4>
                                <p class="text-xs lg:text-sm text-slate-400 font-light leading-snug">Diseño intuitivo y fácil de usar para aumentar la fidelización de clientes.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="group p-4 bg-slate-800/30 rounded-xl hover:bg-slate-800/50 border border-slate-700/50 hover:border-sky-500/30 transition-all duration-300">
                        <div class="flex items-start gap-3 lg:gap-4">
                            ...
                            <div>
                                <h4 class="text-white font-medium text-base lg:text-lg mb-0.5">Soluciones Escalables</h4>
                                <p class="text-xs lg:text-sm text-slate-400 font-light leading-snug">Tecnología preparada para crecer contigo y adaptarse al futuro.</p>
                            </div>
                        </div>
                    </div>

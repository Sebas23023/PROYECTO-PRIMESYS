...
<head>
    ...
    <title>Gestión de Procesos (BPM) - PRIMESYS</title>
        ...
        <div class="px-6 py-8 md:px-12 lg:py-0 lg:pl-8 lg:pr-12 xl:pl-16 xl:pr-20 flex flex-col justify-center flex-grow space-y-8 xl:space-y-10">
            ...
            <div class="space-y-4">
                ...
                <p class="text-base lg:text-lg text-slate-400 font-light leading-7 lg:leading-7 border-l-2 border-slate-700 pl-4 lg:pl-6">
                    La Gestión de Procesos Empresariales (BPM) es una disciplina enfocada en analizar, diseñar, implementar, monitorear y optimizar los procesos de una organización para mejorar su eficiencia.
                </p>
            </div>
            ...
            <div class="space-y-6">
                ...
                <p class="text-sm lg:text-base text-slate-300 font-light leading-6">
                    Estructuramos y automatizamos los procesos clave para alcanzar mayor control y productividad:
                </p>
                ...
                <div class="grid gap-4">
                    ...
                    <div class="group p-4 bg-slate-800/30 rounded-xl hover:bg-slate-800/50 border border-slate-700/50 hover:border-sky-500/30 transition-all duration-300">
                        <div class="flex items-start gap-3 lg:gap-4">
                            <div class="bg-sky-500/10 p-2 lg:p-3 rounded-lg text-sky-400">
                                <svg class="w-5 h-5 lg:w-6 lg:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                            </div>
                            <div>
                                <h4 class="text-white font-medium text-base lg:text-lg mb-0.5">Análisis de Procesos</h4>
                                <p class="text-xs lg:text-sm text-slate-400 font-light leading-snug">Identificación precisa de cuellos de botella, ineficiencias y oportunidades de mejora.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="group p-4 bg-slate-800/30 rounded-xl hover:bg-slate-800/50 border border-slate-700/50 hover:border-purple-500/30 transition-all duration-300">
                        <div class="flex items-start gap-3 lg:gap-4">
                            ...
                            <div>
                                <h4 class="text-white font-medium text-base lg:text-lg mb-0.5">Automatización de Flujos</h4>
                                <p class="text-xs lg:text-sm text-slate-400 font-light leading-snug">Implementación de soluciones digitales que reducen tareas repetitivas y manuales.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="group p-4 bg-slate-800/30 rounded-xl hover:bg-slate-800/50 border border-slate-700/50 hover:border-sky-500/30 transition-all duration-300">
                        <div class="flex items-start gap-3 lg:gap-4">
                            <div class="bg-sky-500/10 p-2 lg:p-3 rounded-lg text-sky-400">
                                <svg class="w-5 h-5 lg:w-6 lg:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                            </div>
                            <div>
                                <h4 class="text-white font-medium text-base lg:text-lg mb-0.5">Capacitación Continua</h4>
                                <p class="text-xs lg:text-sm text-slate-400 font-light leading-snug">Acompañamiento experto para mantener procesos eficientes a largo plazo.</p>
                            </div>
                        </div>
                    </div>

...
<head>
    ...
    <title>Planificación Estratégica - PRIMESYS</title>
        ...
        <div class="px-6 py-8 md:px-12 lg:py-0 lg:pl-8 lg:pr-12 xl:pl-16 xl:pr-20 flex flex-col justify-center flex-grow space-y-8 xl:space-y-10">
            ...
            <div class="space-y-4">
                ...
                <p class="text-base lg:text-lg text-slate-400 font-light leading-7 lg:leading-7 border-l-2 border-slate-700 pl-4 lg:pl-6">
                    La planificación estratégica es el proceso mediante el cual los líderes definen el rumbo de la organización, estableciendo acciones concretas para cumplir la misión y visión, asegurando el crecimiento y mejora continua.
                </p>
            </div>
            ...
            <div class="space-y-6">
                ...
                <p class="text-sm lg:text-base text-slate-300 font-light leading-6">
                    Impulsamos la sostenibilidad de tu negocio con estrategias efectivas:
                </p>
                ...
                <div class="grid gap-4">
                    ...
                    <div class="group p-4 bg-slate-800/30 rounded-xl hover:bg-slate-800/50 border border-slate-700/50 hover:border-sky-500/30 transition-all duration-300">
                        <div class="flex items-start gap-3 lg:gap-4">
                            ...
                            <div>
                                <h4 class="text-white font-medium text-base lg:text-lg mb-0.5">Metas Claras</h4>
                                <p class="text-xs lg:text-sm text-slate-400 font-light leading-snug">Establecemos objetivos medibles y alcanzables que guían el rumbo de la empresa.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="group p-4 bg-slate-800/30 rounded-xl hover:bg-slate-800/50 border border-slate-700/50 hover:border-purple-500/30 transition-all duration-300">
                        <div class="flex items-start gap-3 lg:gap-4">
                            <div class="bg-purple-500/10 p-2 lg:p-3 rounded-lg text-purple-400">
                                <svg class="w-5 h-5 lg:w-6 lg:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z"></path></svg>
                            </div>
                            <div>
                                <h4 class="text-white font-medium text-base lg:text-lg mb-0.5">Análisis de Entorno</h4>
                                <p class="text-xs lg:text-sm text-slate-400 font-light leading-snug">Identificamos oportunidades, riesgos y fortalezas para una mejor toma de decisiones.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="group p-4 bg-slate-800/30 rounded-xl hover:bg-slate-800/50 border border-slate-700/50 hover:border-sky-500/30 transition-all duration-300">
                        <div class="flex items-start gap-3 lg:gap-4">
                            ...
                            <div>
                                <h4 class="text-white font-medium text-base lg:text-lg mb-0.5">Transformación Total</h4>
                                <p class="text-xs lg:text-sm text-slate-400 font-light leading-snug">Alineamos toda la organización con la visión y misión corporativa.</p>
                            </div>
                        </div>
                    </div>
